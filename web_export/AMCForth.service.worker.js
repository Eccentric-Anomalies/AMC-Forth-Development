...
/** @type {string} */
const CACHE_VERSION = '1732718269|56212694196';
/** @type {string} */
const CACHE_PREFIX = 'AMC Forth Develo-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'AMCForth.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["AMCForth.html","AMCForth.js","AMCForth.offline.html","AMCForth.icon.png","AMCForth.apple-touch-icon.png","AMCForth.worker.js","AMCForth.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["AMCForth.wasm","AMCForth.pck"];
