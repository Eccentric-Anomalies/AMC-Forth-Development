...
namespace Forth.String
{
	...
	public partial class CMove : Forth.Words
	{
		...
		public CMove(AMCForth forth, string wordset) : base(forth, wordset)
		{
			Name = "CMOVE";
			Description = "Copy u characters from addr1 to addr2. The copy proceeds from LOWER to HIGHER addresses.";
